...
const MenuBase: React.FunctionComponent<MenuProps> = ({ helloWorldMessage, helloWorldSuccess, helloWorld }) => (
    <>
        ...
        <p>
            Hello world fired - message is "{helloWorldMessage}" and success is "{helloWorldSuccess.toString()}"
        </p>
    </>
)
